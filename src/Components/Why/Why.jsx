...
const Why = () => {
  ...
  return (
    <Container fluid className="why">
        <Row>
          <Col lg={6} style={{padding:"0"}}  data-aos='fade-right' data-aos-duration='1000'>
            <Image src={oil} fluid />
          </Col>
          <Col lg={6} >
            <h2 className="text-center mt-3">Why Goa natural?</h2>
            <Row>
              ...
              <p className="mt-2 desc"> Selected ingredients, unrefined, chemical-free hygenic processes
                to provide genuine products</p>        
              </Col>
              <Col md={4} data-aos='zoom-in' data-aos-duration='1000'>
              <img
               src={whyimg2}
              ...
              />
                ...
                <p className="mt-2 desc">   Use of techniques like Cold Press, Stone Grinder, Mortar Pestle,
                Sun Drying, etc. to promote local craft.</p>
              </Col>
              <Col md={4} data-aos='zoom-in' data-aos-duration='1000'>
              <img
               src={whyimg3}
              ...
              /> 
                ...
                <p className="mt-2 desc">  Natural, Whole & Unrefined food retain more nutrients than
               conventionally produced food.</p>       
              </Col>
              <Col md={4} data-aos='zoom-in' data-aos-duration='1000'>
              <img
               src={whyimg4}
              ...
              />   
                ...
                <p className="mt-2 desc">All by-products after processing are used as livestock feed,
                thus leaving zero leftovers.</p>     
              </Col>
              <Col md={4} data-aos='zoom-in' data-aos-duration='1000'>
              <img
               src={whyimg5}
              ...
              />    
                ...
                <p className="mt-2 desc"> Supports natural, organic agricultural practices that serve and
                protect Mother Nature.</p>    
              </Col>
              <Col md={4} data-aos='zoom-in' data-aos-duration='1000'>
              <img
               src={whyimg6}
              ...
              <p className="head">And only the Best</p>
                <p className="mt-2 desc">  Our endeavor is to create not just the best products but the
                best lifestyle.</p>     
              </Col>
            </Row>
          </Col>
